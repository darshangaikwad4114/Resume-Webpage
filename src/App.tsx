          ...
          <div className="px-6 sm:px-8 py-6 space-y-8">
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                <div>
                  ...
                  <p className="text-gray-900 dark:text-white font-medium mt-1">
                    CGPA: 8.79/10.00 With A+ Grade
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 mt-2 leading-relaxed">
                    Relevant Coursework: Object-Oriented Programming, Database
                    Management System, Data Structures and Algorithms, Operating
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-2.5 gap-x-4 text-gray-700 dark:text-gray-300">
                <SkillItem
                  ...
                  skills="JavaScript, HTML, CSS, SCSS, SQL"
                />
                <SkillItem
                  category="Frameworks"
                  skills="React, Node.js, Express, TailwindCSS, Bootstrap"
                />
                <SkillItem
                  category="Databases & Deployments"
                  skills="MongoDB, MySQL, Firebase, Vercel"
                />
                <SkillItem
                  category="Development Tools"
                  skills="Webpack, Vite, GitHub, Git, Visual Studio Code, Postman"
                />
              </div>
            </section>
            ...
            >
              ...
              <div>
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                  <h3 className="font-semibold text-gray-900 dark:text-white">
                    Idle Solutions Pvt Ltd
                  </h3>
                  <p className="text-gray-700 dark:text-gray-300 mt-1 sm:mt-0 shrink-0 sm:ml-4">
                    Pune, India
                  </p>
                </div>
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mt-1">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mt-1 sm:mt-0 shrink-0 sm:ml-4">
                    Nov - Dec 2022
                  </p>
                </div>
                <ul className="list-disc ml-4 mt-3 text-gray-7 00 dark:text-gray-300 space-y-2 leading-relaxed">
                  <li>
                    Optimized website structure by refactoring HTML and
            ...
            <section
              className="animate-slide-in [animation-delay:1000ms]"
              aria-labelledby="honors-heading"
            >
              <SectionHeading id="honors-heading">
                HONORS & INVOLVEMENT
              </SectionHeading>
              <ul className="list-disc ml-4 text-gray-700 dark:text-gray-300 space-y-2 leading-relaxed">
                ...
                <li>
                  NodeJS Masterclass (Nodejs, Rest API, Express, MongoDB) -
